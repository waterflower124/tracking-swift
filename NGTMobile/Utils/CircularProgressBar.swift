...
//            label.font = UIFont.systemFont(ofSize: labelSize)
            label.font = UIFont(name:"RobotoCondensed-Light", size: labelSize)
...
//            } else {
//                currentTime += 0.05
//                let percent = currentTime/0.5 * 100
...
//        timer.fire()
    ...
    private func drawForegroundLayer(){
        ...
        foregroundLayer.strokeColor = UIColor(red: 0/255, green: 187/255, blue: 0/255, alpha: 1).cgColor
...
//        }
        self.foregroundLayer.strokeColor = UIColor(red: 0/255, green: 187/255, blue: 0/255, alpha: 1).cgColor
    }
